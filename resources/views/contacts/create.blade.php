		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
				...
				<p><span class="text-muted">
					...
					<a href="{{config('laracarte.admin_support_mail')}}" 
					data-helpful="laracarte"
					data-helpful-modal="on">
					ask for help</a>.</span>
				</p>
				...
				<form method="POST" action="/contact">
		            ...
		            <div class="form-group">
		                <button type="submit" class="btn btn-success btn-block">Submit Enquiry &raquo;</button>
		            </div>
		        </form>
			</div>
		</div>
